#!/usr/bin/env python3
"""
Generate TVA PSRF forcing data (1980-1999, 20 years, 3-hour resolution)
Corresponding to crujra.v2.5.5d_PSRF_1901-2023_z01.nc
...
start_year = 1980
end_year = 1999
final_output_file = os.path.join(out_dir, f"TVA_PSRF_{start_year}-{end_year}.nc")

print("="*80)
print("Generate TVA PSRF forcing data")
...
try:
    with xr.open_mfdataset(all_monthly_files, combine='nested', concat_dim='time',
        ...
        if calendar.lower() == 'no_leap': calendar = 'noleap'
        ...
        output_encoding = {
            'PSRF': {'zlib': True, 'complevel': 4, 'dtype': 'float32'},
